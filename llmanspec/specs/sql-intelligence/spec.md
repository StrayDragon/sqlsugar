...
requirements[10]{req_id,title,statement}:
  ...
  "R-SQL-007",SQL Parser 集成,"系统 MUST 集成 node-sql-parser 支持多方言 AST 解析"
  "R-SQL-008",格式化引擎,"系统 MUST 集成 sql-formatter 并支持 Format Document 命令"
  "R-SQL-009",Jinja2 模板兼容,系统 MUST 在验证 SQL 时智能处理 Jinja2/Nunjucks 模板语法不产生误报
  "R-SQL-010",内联 SQL 验证,"系统 SHALL 对 inline-sql 临时文件提供实时语法验证"
